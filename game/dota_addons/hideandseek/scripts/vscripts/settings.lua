...
FIXED_RESPAWN_TIME = 120                 -- What time should we use for a fixed respawn timer?  Use -1 to keep the default dota behavior.
...
TEAM_COLORS[DOTA_TEAM_BADGUYS]  = { 52, 85, 255 }   --    Yellow
